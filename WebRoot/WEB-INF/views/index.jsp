		...
		layout_west_tree = $('#layout_west_tree').tree({
			...
			onClick : function(node) {
				if (node.attributes && node.attributes.url) {
					var url = '';
					if(node.attributes.url.substr(0,5)=='http:') 
...
<body>
	...
	<div id="index_layout">
		<div data-options="region:'north',border:false" style=" overflow: hidden;" >
			...
			<c:if test="${sessionInfo.loginname !='test'}">
			<a href="javascript:void(0)" onclick="editUserPwd()" style="color: #ff0000">修改密码</a>&nbsp;&nbsp;
			 </c:if>
			<a href="javascript:void(0)" onclick="logout()" style="color: #ff0000">安全退出</a>
        	&nbsp;&nbsp;&nbsp;&nbsp;
    		</span>
    		<span></span>
    		</div>
		...
		<div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >版权所有 @ 中国人民银行温州市中心支行</div>
	</div>
