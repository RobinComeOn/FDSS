	...
	<div class="login">
		<form  method="post" id="loginform">
		    ...
		    <div class="login_form">
		    	<div class="user">
		        	<input class="text_value" type="text" id="loginname" name="loginname" data-options="required:true" value=""></input>
		            <input class="text_value" type="password" id="password"  name="password" value="" ></input>
		        </div>
		    ...
		    <br> 
		    <div class="foot"><a href="javascript:void(0)" onclick="nouser()">访客登陆请点击这里</a></div>
		    <br> <br> <br> <br><br> <br><br><br> <br><br> <br>
		     
		    <div class="foot">copyright 2016  中国人民银行温州市中心支行 版权所有</div>
	   </form>
     </div>
